...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Notify Graduates</h1>
        ...
        <div class="d-flex">
            ...
            <form action="{{ route('admin.graduates.notify') }}" method="POST" enctype="multipart/form-data" class="w-100">
                @csrf
                    ...
                    <input type="hidden" name="graduate" value="true">
                    <div class="mb-3">
                    ...
                    <input type="file" name="excel_file" class="form-control p-2 w-100 w-md-50" accept=".xlsx,.xls" required>
